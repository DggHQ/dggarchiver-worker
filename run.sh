...
case "$LIVESTREAM_PLATFORM" in
	...
	"kick" )
		...
		yt-dlp --fixup force --downloader ffmpeg --hls-use-mpegts -f 'best[height=720][fps=30] / best[height=720][fps=60] / best[height=480] / best[height=360] / best' -o "/videos/${LIVESTREAM_PLATFORM}_${LIVESTREAM_ID}.%(ext)s" "$LIVESTREAM_URL"
		;;
esac
